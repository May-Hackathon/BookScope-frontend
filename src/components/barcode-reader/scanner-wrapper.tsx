...
import Styles from "./scanner-wrapper.module.scss";
  ...
  return (
    <div className={Styles.wrapper}>
      <div className={Styles.control}>
        <span onClick={cancel} className={Styles.button}>キャンセル</span>
      </div>
      <div ref={scannerRef} className={Styles.view}>
        ...
        {state===1 ? <Scanner scannerRef={scannerRef} onDetected={onDetect} /> : null}
      </div>
    </div>
  );
}
